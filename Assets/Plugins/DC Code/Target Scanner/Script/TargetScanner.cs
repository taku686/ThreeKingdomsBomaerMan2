...
namespace DC.Scanner
{
    ...
    public class TargetScanner
    {
        ...
        [Tooltip("Center of Scanner")] [SerializeField]
        bool ScannerGizmos;

        [Tooltip("Center of Scanner")] [SerializeField]
        Transform transform;

        [Tooltip("Radius within which scanner will always detect Target")] [SerializeField]
        private float alertRadius = 1f;

        [Tooltip("Detection Radius of the Scanner")] [SerializeField]
        private float viewRadius = 5f;

        [Tooltip("Field Of View of the Scanner")] [Range(0f, 360f)] [SerializeField]
        private float viewAngle = 60f;

        [Tooltip("Layer of Target")] [SerializeField]
        private LayerMask targetLayer;

        [Tooltip("Layer of objects which Scanner should not see through")] [SerializeField]
        private LayerMask obstacleLayer;

        [SerializeField] private float heightOffset = 0;

        [Tooltip("Max Height Detection Range, Detect both Upward & Downward")] [SerializeField]
