...
Shader "PUROPORO/Built-in/Casual Specular (Texture with Ramp, Glowing)"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				finalColor = ( ( ( ( SAMPLE_TEXTURE2D( _BaseMap, sampler_BaseMap, uv_BaseMap ) * SAMPLE_TEXTURE2D( _BaseMap, sampler_BaseMap, appendResult47.xy ) ) * ase_lightColor ) + SAMPLE_TEXTURE2D( _BaseMap, sampler_BaseMap, appendResult46.xy ) ) + ( _VFXGlowingPower * _VFXGlowingColor ) );
				return finalColor;
			}
			ENDCG
		}
...
Node;AmplifyShaderEditor.RangedFloatNode;57;-1274.981,15.56079;Inherit;False;Constant;_Float0;Float 0;6;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;54;76.02863,418.86;Inherit;False;Property;_VFXGlowingPower;VFX Glowing Power;4;0;Create;False;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;53;144.1422,491.3585;Inherit;False;Property;_VFXGlowingColor;VFX Glowing Color;3;0;Create;False;0;0;0;False;0;False;1,1,1,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=34766974E133E84D1D74419290C9334908CAEAD1