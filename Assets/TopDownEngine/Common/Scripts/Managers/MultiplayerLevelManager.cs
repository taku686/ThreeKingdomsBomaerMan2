...
namespace MoreMountains.TopDownEngine
{
    ...
    public class MultiplayerLevelManager : LevelManager
    {
        ...
        protected virtual void HandleCameraModes()
        {
            ...
            {
                if (GroupCameraRig != null)
                {
                    GroupCameraRig.SetActive(false);
                }

                if (SplitCameraRig != null)
                {
                    SplitCameraRig.SetActive(true);
                }
            ...
            if (CameraMode == CameraModes.Group)
            {
                if (GroupCameraRig != null)
                {
                    GroupCameraRig?.SetActive(true);
                }

                if (SplitCameraRig != null)
                {
                    SplitCameraRig?.SetActive(false);
                }
        ...
        /// </summary>
        protected override void PlayerDead(Character playerCharacter)
        {
            ...
            var characterHealth = playerCharacter.CharacterHealth;
