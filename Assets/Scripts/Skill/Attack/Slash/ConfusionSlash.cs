...
namespace Skill.Attack
{
    public class ConfusionSlash : SlashBase
    {
        ...
        public override void Attack()
        {
            ...
            Slash(AbnormalCondition.Confusion, _animator, _targetScanner, _skillId, _playerTransform);
        }
        ...
        public class Factory : PlaceholderFactory<int, TargetScanner, Animator, Transform, IAttackBehaviour, ConfusionSlash>
        {
        }
    }
}