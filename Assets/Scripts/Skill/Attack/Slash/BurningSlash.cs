...
namespace Skill.Attack
{
    public class BurningSlash : SlashBase
    {
        ...
        public override void Attack()
        {
            ...
            Slash(AbnormalCondition.Burning, _animator, _targetScanner, _skillId, _playerTransform);
        }
        ...
        public class Factory : PlaceholderFactory<int, TargetScanner, Animator, Transform, IAttackBehaviour, BurningSlash>
        {
        }
    }
}