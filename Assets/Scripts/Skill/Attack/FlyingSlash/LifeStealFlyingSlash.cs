...
{
    public class LifeStealFlyingSlash : FlyingSlashBase
    {
        ...
        public override void Attack()
        {
            ...
            FlyingSlash(AbnormalCondition.LifeSteal, _animator, _skillId, _playerTransform);
        }
