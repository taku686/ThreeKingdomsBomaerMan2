...
{
    public class ParalysisFlyingSlash : FlyingSlashBase
    {
        ...
        public override void Attack()
        {
            ...
            FlyingSlash(AbnormalCondition.Paralysis, _animator, _skillId, _playerTransform);
        }
