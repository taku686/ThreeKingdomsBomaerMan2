...
namespace UI.Title
{
    public class CharacterDetail : ViewBase
    {
        ...
        private void SetStatusView(CharacterData characterData, CharacterLevelData currentLevelData)
        {
            ...
            var characterStatusView = statusView;
            characterStatusView.HpText.text = GetFixedStatus(currentLevelData, characterData.Hp).ToString();
            characterStatusView.DamageText.text =
                GetFixedStatus(currentLevelData, characterData.Attack).ToString();
            characterStatusView.SpeedText.text =
                GetFixedStatus(currentLevelData, characterData.Speed).ToString();
            characterStatusView.BombLimitText.text =
                GetFixedStatus(currentLevelData, characterData.BombLimit).ToString();
        ...
        private int GetFixedStatus(CharacterLevelData currentLevelData, int value)
        {
